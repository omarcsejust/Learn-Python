...
if key does not exist then it will return None instead of terminating the program
"""
print(dict_person.get('named'))

# get all keys from a dictionary
dict_keys_list = dict_person.keys()
print("Dict keys list: ", dict_keys_list)

# get all values from a dictionary
dict_values_list = dict_person.values()
